    ...
    var oldPswCorrect=-1;
        ...
        function generalAfterGetData(data){
            if(data=="SuccessUpdate"){
                ...
                $("#profileOpen").html("Bonjour, "+newName);
            }
            if(data=="ErrorUpdate"){
                $("#generalmsg").html("Erreur :(");
                ...
                <div class="profile-wrap">
                    <div class="user-card">
                        <div class="change-pic">
                            ...
                            <div class="user-picture-cover">Changer d’image</div>
                        </div>
                    ...
                    <div class="user-data-container">
                        <div class="page-selector">
                            ...
                            <div class="select-item" id="selectUserInfo">Info</div>
                            <div class="select-item" id="selectOrders">Commandes</div>
                            <div class="select-item" id="selectChange">Modifier</div>
                            <?php
                            if($_SESSION['UserStatus']>=1){
                            ?>
                            <div class="select-item" id="selectAdminAddProduct">Ajouter prod</div>
                            <?php
                            }
                            if($_SESSION['UserStatus']>=2){
                            ?>
                            <div class="select-item" id="selectAdminViewOrders">Commandes</div>
                            <?php
                            }
                            ?>                                                       
                        </div>
                        <div class="page-container">
                            <div class="page" id="UserInfo">
                                <table>
                                    <tr class="table-row">
                                        <td class="table-head">Prénom</td>
                                        <td class="table-data" id="info-name"><?=$_SESSION['UserName']?></td>
                                    </tr>
                                    <tr class="table-row">
                                        <td class="table-head">Nom</td>
                                        <?php
                                        ...
                                        ?>
                                            <td class="table-data" id="info-surname">&ltNom n'est pas défini&gt</td>
                                        <?php
                                        }
                                        ?>
                                    </tr>
                                    <tr class="table-row">
                                        <td class="table-head">Date d'enregistrement</td>
                                        <td class="table-data"><?=str_replace("-",".",$_SESSION['UserRegisterDate'])?></td>
                                    </tr>
                                    <tr class="table-row">
                                        <td class="table-head">Date de naissance</td>
                                        <?php
                                        ...
                                        ?>
                                            <td class="table-data" id="info-birth-date">&ltN'est pas défini&gt</td>
                                        <?php
                                        }
                                        ?>
                                    </tr>
                            ...
                            <div class="page" id="Orders">
                                <table class="orders-table">
                                    <tr>
                                        ...
                                        <td class="orders-table-list">Liste d'éléments</td>
                                        <td class="orders-table-price">Prix</td>
                                        <td class="orders-table-delivery">Livraison</td>
                                    </tr>
                                </table>
                            ...
                            <div class="page" id="ChangeUserInfo">
                                <div class="change-container" id="general">
                                    ...
                                    <button class="change-save" id="saveGeneral">Sauver</button>
                                    <div class="change-cover" id="generalLoadCover">
                                        <div class="load-cont" id="generalLoadCont">
                                            <div class="lds-ellipsis"><div></div><div></div><div></div><div></div></div>
                                        </div>
                                        <div class="change-message" id="generalmsg">Succès!</div>
                                    </div>
                                </div>
                                <div class="change-container" id="password">
                                    <div class="change-header">Mot de passe</div>
                                    <div class="change-input-header">Ancien mot de passe</div>
                                    <input type="password" class="change-input" name="change-input-old-password" id="change-input-old-password">
                                    <div class="change-input-header">Nouveau mot de passe</div>
                                ...
                                <div class="add-product-container">
                                    ...
                                    <div class="admin-inputs-row">
                                        <div class="admin-picture-column">
                                            <div class="admin-picture-header">Image 1</div>
                                            <input type="file" class="admin-picture-input" accept="image/*" name="pic1" id="pic1">
                                            <button id="picBtn1">Choisissez Fichier</button>
                                        </div>
                                        <div class="admin-picture-column">
                                            <div class="admin-picture-header">Image 2</div>
                                            <input type="file" class="admin-picture-input" accept="image/*" name="pic2" id="pic2">
                                            <button id="picBtn2">Choisissez Fichier</button>
                                        </div>
                                        <div class="admin-picture-column">
                                            <div class="admin-picture-header">Image 3</div>
                                            <input type="file" class="admin-picture-input" accept="image/*" name="pic3" id="pic3">
                                            <button id="picBtn3">Choisissez Fichier</button>
                                        </div>
                                        <div class="admin-picture-column">
                                            <div class="admin-picture-header">Image 4</div>
                                            <input type="file" class="admin-picture-input" accept="image/*" name="pic4" id="pic4">
                                            <button id="picBtn4">Choisissez Fichier</button>
                                        </div>
                                        <div class="admin-picture-column">
                                            <div class="admin-picture-header">Image 5</div>
                                            <input type="file" class="admin-picture-input" accept="image/*" name="pic5" id="pic5">
                                            <button id="picBtn5">Choisissez Fichier</button>
                                        </div>
                                    </div>
                                    <div class="add-product-btn">Ajouter le produit</div>
                                </div>
                            ...
                            <div class="page" id="AdminViewOrders">
                                ...
                                ?>
                                    <div class="orders-row" id="<?=$Orders['OrderID']?>">
                                        ...
                                        <button class="delete-order">Supprimer</button>
